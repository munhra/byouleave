...
public class BluetoothConnection extends Service {
    ...
    private void createConnectionCallBack() {
        btleGattCallback = new BluetoothGattCallback() {
            ...
            public void onConnectionStateChange(BluetoothGatt gatt, int status, int newState) {
                ...
                //final TextView statusText = (TextView) MainActivity.findViewById(R.id.doorStatusText);
                ...
                Intent atualizarStatusBLE = new Intent("Atualizar Status do TextView de Conexao do Bluetooth");
                sendDataToActivity(atualizarStatusBLE, "TextView de Status", "BLE Connected");
            }
            ...
            public void onCharacteristicChanged(BluetoothGatt gatt, BluetoothGattCharacteristic characteristic) {
                ...
                Intent openDoor = new Intent("Abrir a porta");
                sendDataToActivity(openDoor, "Porta Aberta", bleText);
    ...
    public void sendDataToActivity(Intent intent, String what, String msg){
        Log.e("Status of Broadcast","Sending Message do Activity");
